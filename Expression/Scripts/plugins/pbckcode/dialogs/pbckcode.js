CKEDITOR.dialog.add('pbckcodeDialog', function (editor) {
    ...
    return {
        ...
        onOk: function () {           
            ...
            pre.setHtml(prettyPrintOne(pre.getHtml(), pre.getAttribute("data-pbcklang"), true));
            // we add a new code tag into ckeditor editor
            if (this.insertMode) {

                //var contents = pre.getText();
            ...
            //debugger;
            //prettyPrintOne(element);
            
            //addEventListener('onload', function (event) { prettyPrint() }, false);
        }
    };
});
